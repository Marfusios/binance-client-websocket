...
namespace Binance.Client.Websocket.Responses.Wallets
{
    ...
    public class Wallet
    {
        ...
        /// </summary>
        public double BalanceBtc => BinanceConverter.ConvertToBtc(Currency, Amount ?? 0);

        /// <summary>
        /// Converted satoshis 'Amount' into decimal BTC representation
        /// </summary>
        public decimal BalanceBtcDecimal => BinanceConverter.ConvertToBtcDecimal(Currency, Amount ?? 0);
    }
}
