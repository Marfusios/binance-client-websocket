...
using Binance.Client.Websocket.Rest.Responses;
using Binance.Client.Websocket.Signing;

namespace Binance.Client.Websocket.Rest
{
    public class BinanceUserRestApi : BinanceSpotRestApi
    {
        public BinanceUserRestApi(string baseUrl = DEFAULT_SPOT_BASE_URL, string? apiKey = null, string? apiSecret = null)
        : this(new HttpClient(), baseUrl: baseUrl, apiKey: apiKey, apiSecret: apiSecret)
        {
        }

        public BinanceUserRestApi(HttpClient httpClient, string baseUrl = DEFAULT_SPOT_BASE_URL, string? apiKey = null, string? apiSecret = null)
        : base(httpClient, baseUrl: baseUrl, apiKey: apiKey, apiSecret: apiSecret)
        {
        }

        public BinanceUserRestApi(HttpClient httpClient, IBinanceSignatureService signatureService, string baseUrl = DEFAULT_SPOT_BASE_URL, string? apiKey = null)
        ...
        public async Task<BinanceListenKeyResponse> CreateSpotListenKey()
        {
